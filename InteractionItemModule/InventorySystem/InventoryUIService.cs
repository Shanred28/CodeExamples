...
namespace GamePlayLogic.GameService.InteractionItemModule.InventorySystem
{
    ...
    public class InventoryUIService : IInventoryInteraction
    {
        ...
        public InventoryUIService(InventoryPresenter inventoryPresenter, IInputService inputService,InventoryUIView viewInventoryUI, IItemSpawnService itemSpawnService)
        {
        ...
        private void Initialize()
        {
            ...
            _dragItemHelper = new DragItemInventory(_inputService, this,_itemSpawnService);
